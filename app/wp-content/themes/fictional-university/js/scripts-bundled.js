...
var _Barba = _interopRequireDefault(__webpack_require__(9));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// 3rd party packages from NPM
var jQuery = _jquery.default;
// Instantiate a new object using our modules/classes
var heroSlider, search, myNotes, like;

function init() {
  var mobileMenu = new _MobileMenu.default();
  var googleMap = new _GoogleMap.default();
  search = new _Search.default();
  myNotes = new _MyNotes.default();
  heroSlider = new _HeroSlider.default();
  like = new _Like.default();
}
...
var barba = new _Barba.default(init, deinit);
init();
...
var ROOT_URL = university_data.root_url;
...
function () {
  ...
  _createClass(Search, [{
    ...
    value: function events() {
      ...
      (0, _jquery.default)(document).on('keydown.search', this.keyPressDispatcher.bind(this));
    }
  }, {
    key: "destroy",
    value: function destroy() {
      ...
      (0, _jquery.default)(document).off('keydown.search');
    }
  }, {
    key: "keyPressDispatcher",
    value: function keyPressDispatcher(e) {
      if (e.key.toLowerCase() === 's' && !this.isOpen && !(0, _jquery.default)('input, textarea').is(':focus')) {
        this.openOverlay();
      }
    ...
    value: function getResults() {
      ...
      _jquery.default.getJSON("".concat(ROOT_URL, "/wp-json/university/v1/search?term=").concat(this.$searchField.val())).then(function (results) {
    ...
    key: "setResults",
    value: function setResults(posts) {
      var generalInfoPosts = posts['generalInfo'];
      var programsPosts = posts['programs'];
      var professorsPosts = posts['professors'];
      var campusesPosts = posts['campuses'];
      var eventsPosts = posts['events'];
      this.isSpinnerVisible = false;
      this.$resultsDiv.html("\n      <div class=\"row\">\n        <div class=\"one-third\">\n          <h2 class=\"search-overlay__section-title\">General Information</h2>\n            ".concat(generalInfoPosts && generalInfoPosts.length > 0 ? "<ul class=\"link-list min-list\">\n                ".concat(generalInfoPosts.map(function (p) {
        return "\n                  <li>\n                    <a href=\"".concat(p.permalink, "\">").concat(p.title, "</a>\n                    ").concat(p.post_type === 'post' ? "by <em>".concat(p.author_name, "</em>") : '', " \n                  </li>\n                ");
      }).join(''), "\n              </ul>") : "<p>No general information matches that search</p>", "\n        </div>\n        <div class=\"one-third\">\n          <h2 class=\"search-overlay__section-title\">Programs</h2>\n            ").concat(programsPosts && programsPosts.length > 0 ? "<ul class=\"link-list min-list\">\n                ".concat(programsPosts.map(function (p) {
        return "\n                  <li>\n                    <a href=\"".concat(p.permalink, "\">").concat(p.title, "</a>\n                  </li>\n                ");
      }).join(''), "\n              </ul>") : "<p>No programs match that search. <a href=\"".concat(ROOT_URL, "/programs\">View all programs</a></p>"), "\n          <h2 class=\"search-overlay__section-title\">Professors</h2>\n            ").concat(professorsPosts && professorsPosts.length > 0 ? "<ul class=\"professor-cards\">\n                ".concat(professorsPosts.map(function (p) {
        return "\n                  <li class=\"professor-card__list-item\">\n                    <a class=\"professor-card\" href=\"".concat(p.permalink, "\">\n                      <img class=\"professor-card__image\" src=\"").concat(p.thumbnail, "\" alt=\"").concat(p.title, "\">\n                      <span class=\"professor-card__name\">").concat(p.title, "</span>\n                    </a>\n                  </li>\n                  <br>\n                ");
      }).join(''), "\n              </ul>") : "<p>No professors match that search</p>", "\n        </div>\n        <div class=\"one-third\">\n          <h2 class=\"search-overlay__section-title\">Campuses</h2>\n            ").concat(campusesPosts && campusesPosts.length > 0 ? "<ul class=\"link-list min-list\">\n                ".concat(campusesPosts.map(function (p) {
        return "\n                  <li>\n                    <a href=\"".concat(p.permalink, "\">").concat(p.title, "</a>\n                  </li>\n                ");
      }).join(''), "\n              </ul>") : "<p>No campuses match that search. <a href=\"".concat(ROOT_URL, "/campuses\">View all campuses</a></p>"), "\n          <h2 class=\"search-overlay__section-title\">Events</h2>\n            ").concat(eventsPosts && eventsPosts.length > 0 ? eventsPosts.map(function (p) {
        return "\n              <div class=\"event-summary\">\n                <a class=\"event-summary__date t-center\" href=\"".concat(p.permalink, "\">\n                  <span class=\"event-summary__month\">\n                    ").concat(p.month, "\n                  </span>\n                  <span class=\"event-summary__day\">\n                    ").concat(p.day, "\n                  </span>  \n                </a>\n                <div class=\"event-summary__content\">\n                  <h5 class=\"event-summary__title headline headline--tiny\"><a href=\"").concat(p.permalink, "\">").concat(p.title, "</a></h5>\n                </div>\n                <p>").concat(p.excerpt, "<a href=\"").concat(p.permalink, "\" class=\"nu gray\">Learn more</a></p>\n              </div>");
      }).join('') : "<p>No events match that search. <a href=\"".concat(ROOT_URL, "/events\">View all events</a></p>"), "\n        </div>\n      </div>\n    "));
    }
  }, {
    key: "addSearchHTML",
...
var ROOT_URL = university_data.root_url;
var NONCE = university_data.nonce;
...
function () {
  ...
  _createClass(MyNotes, [{
    ...
    key: "deleteNote",
    value: function deleteNote(ev) {
      var $thisNote = (0, _jquery.default)(ev.target).parents('li');
      var id = $thisNote.data('id');

      _jquery.default.ajax({
        url: "".concat(ROOT_URL, "/wp-json/wp/v2/note/").concat(id),
        type: 'DELETE',
        ...
        success: function success(res) {
          ...
          $thisNote.slideUp(null, null, function () {
            return $thisNote.remove();
          });
    ...
    value: function makeNoteEditable(note) {
      var $thisNote = (0, _jquery.default)(note);
    ...
    value: function createNote(ev) {
      ...
      _jquery.default.ajax({
        url: "".concat(ROOT_URL, "/wp-json/wp/v2/note"),
        type: 'POST',
        beforeSend: function beforeSend(xhr) {
          xhr.setRequestHeader('X-WP-NONCE', NONCE);
        },
        success: function success(res) {
          console.log('congrats:', res);
          (0, _jquery.default)('.new-note-title').val('');
          (0, _jquery.default)('.new-note-body').val('');

          _this2.insertNewNote({
            id: res.id,
            title: res.title.raw,
    ...
    key: "insertNewNote",
    value: function insertNewNote(_ref) {
      var id = _ref.id,
          title = _ref.title,
          body = _ref.body;
      (0, _jquery.default)("\n      <li data-id=\"".concat(id, "\">\n        <input readonly class=\"note-title-field\" type=\"text\" value=\"").concat(title, "\">\n        <span class=\"edit-note\"><i class=\"fa fa-pencil\" aria-hidden=\"true\"></i> Edit</span>\n        <span class=\"delete-note\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i> Delete</span>\n        <textarea readonly class=\"note-body-field\" name=\"\" id=\"\" cols=\"30\" rows=\"10\">").concat(body, "</textarea>\n        <span class=\"btn btn--blue btn--small update-note\"><i class=\"fa fa-arrow-right\" aria-hidden=\"true\"></i> Save</span>\n      </li>\n    ")).prependTo('#my-notes').hide().fadeIn();
    }
  }]);
...
function () {
  ...
  _createClass(Like, [{
    ...
    value: function ourClickDispatcher(ev) {
      var $currentLikeBox = (0, _jquery.default)(ev.target).closest('.like-box');
    ...
    value: function createLike($currentLikeBox) {
      ...
      _jquery.default.ajax({
        url: "".concat(ROOT_URL, "/wp-json/university/v1/manageLike"),
        beforeSend: function beforeSend(xhr) {
          xhr.setRequestHeader('X-WP-NONCE', NONCE);
        },
        data: {
        ...
        type: 'POST',
        success: function success(res) {
          var $countEl = $currentLikeBox.find('.like-count');
...
var _barba = _interopRequireDefault(__webpack_require__(10));
...
var oldPreventCheck = _barba.default.Pjax.preventCheck.bind(_barba.default.Pjax);

_barba.default.Pjax.preventCheck = function (evt, element) {
  var res = oldPreventCheck(evt, element);

  if (res) {
    var href = (0, _jquery.default)(element).attr('href');
...
var FadeTransition = _barba.default.BaseTransition.extend({
  ...
  fadeOut: function fadeOut() {
     ...
     */
    return (0, _jquery.default)(this.oldContainer).animate({
      opacity: 0
    }, 200).promise();
  },
  fadeIn: function fadeIn() {
    ...
    var $el = (0, _jquery.default)(this.newContainer);
    (0, _jquery.default)(document).scrollTop(0);
    var $newHTML = (0, _jquery.default)("<div>".concat(_barba.default.Pjax.Dom.currentHTML, "</div>")); // replace the header with the new one

    (0, _jquery.default)('header').html($newHTML.find('header').html());
    (0, _jquery.default)(this.oldContainer).hide(); // replace admin toolbar

    (0, _jquery.default)('#wpadminbar').html($newHTML.find('#wpadminbar').html());
    init();
    $el.css({
      visibility: 'visible',
      opacity: 0
...
/*#__PURE__*/
function () {
  function BarbaSetup(_init, deinit) {
    _classCallCheck(this, BarbaSetup);
  ...
  _createClass(BarbaSetup, [{
    ...
    value: function events() {
      ...
      //   }, 400);
      // });
      _barba.default.Dispatcher.on('linkClicked', function () {
        _this2.deinit();
      });
    }
  }]);
